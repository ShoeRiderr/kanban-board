                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <div v-if="task" class="d-flex align-items-center w-100">
                            ...
                            <div class="pl-1">
                                <div class="d-flex">
                                    <span :class="getEstimationStatus.duration_class" :style="setDurationMargin">
                                        {{ convertedCurrentTaskDuration }}
                                    </span>
                                    <span :class="getEstimationStatus.estimation_class">
                                        {{ taskForm.estimation }}h
                                    </span>
                                </div>
                                <div :class="getEstimationStatus.progress_bar" class="animated-progress">
                                    <span :style="`width: ${getEstimationStatus.value}%`"></span>
                                </div>
                            </div>
                            <div class="ml-auto">
                                <i
                    ...
                    <div class="modal-body">
                        <div class="p-1 scrollable">
                                ...
                                <div class="col-8">
                                    ...
                                    >
                                        <div v-if="task.user" class="d-flex align-items-center">
                                            ...
                                            <span class="ml-1">{{ task.user.fullname }}</span>
                                        </div>
                            ...
                            <div class="row pb-1">
                                <div class="col-3">
                                    <label class="form-label">Production links</label>
                                </div>
                                <div class="col-8">
                                    <production-file-component
                                        class="pb-1"
                                        v-for="(productionFile, index) in task.production_files"
                                        :key="index"
                                        :production-file="productionFile"
                                        @addProductionFile="addProductionFile"
                                    />
                                    <div class="d-flex justify-content-end">
                                        <span class="text-secondary pointer" @click="pushProductionFile">
                                            <small>
                                                <u> Add link </u>
                                            </small>
                                        </span>
                            ...
                            <div class="row pb-1">
                                ...
                                <div class="col-8 editor-form">
                                    ...
                                    >
                                        ...
                                        <div v-else class="text-secondary">Write more detail to this task...</div>
                                    </span>
...
import ProductionFileComponent from '@/components/kanbanBoard/ProductionFileComponent.vue';
...
export default {
    ...
    watch: {
        task: {
            handler() {
                const { id, name, description, due_date, column, user, project, tags } = this.task;
    ...
    mounted() {
        ...
        this.$set(this.taskForm, 'estimation', this.convertedEstimation());
    },
    ...
    methods: {
        ...
        assignProject() {
            ...
            formData.append('project_id', this.taskForm.project ? this.taskForm.project.id : '');
        ...
        pushProductionFile() {
            this.task.production_files.push({
                value: '-',
                input_focus: true,
            });
        },

        addProductionFile(event) {
            const { production_file, index } = event;

            if (production_file.value.length === 0) {
                production_file.id
                    ? api.kanbanBoard.productionFile
                          .delete(production_file.id)
                          .then(() => {
                              this.$notify({
                                  group: 'alert',
                                  title: 'Success',
                                  type: 'success',
                                  text: 'Production file deleted.',
                              });
                          })
                          .catch((error) => {
                              this.$notify({
                                  ...
                                  title: 'Error',
                                  type: 'error',
                                  text: 'Something went wrong during deleting the production file.',
                              });
                          })
                    : this.task.production_files.splice(index, 1);

                return;
            }

            production_file.id
                ? api.kanbanBoard.productionFile.update(production_file.id, {
                      value: production_file.value,
                  })
                : this.editTask({
                      production_file,
                  });

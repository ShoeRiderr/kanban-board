<template>
  <span @click="openAttachment(false)" class="d-flex">
    <div data-attachment="true" class="attachment-image-box mb-1">
      <img
        v-if="isImage"
        data-attachment="true"
        class="attachment-img pointer"
        :src="fileAttachment"
        alt="Image"
      />
    ...
    <div class="ps-1">
      <span data-attachment="true" class="pointer">{{ file.origin_name }}</span>
